...
export default function ImageInfoBar(props: ImageInfoBarProps) {
  ...
  return (
    <div
      ...
      class="flex flex-wrap items-center gap-x-2 gap-y-0.5 text-xs text-muted-foreground bg-lavender-50 border border-border-light rounded-md px-3.5 py-2 shrink-0"
    >
