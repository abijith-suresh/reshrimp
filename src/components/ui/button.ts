...
const BASE_BUTTON_CLASSES =
  "relative inline-flex shrink-0 items-center justify-center gap-2 overflow-hidden whitespace-nowrap rounded-sp-full border-none font-body font-semibold no-underline transition-all duration-300 outline-none focus-visible:ring-2 focus-visible:ring-sp-lavender/40 disabled:pointer-events-none disabled:opacity-50 [&_svg]:shrink-0";

const SIZE_CLASSES: Record<ButtonSize, string> = {
  default: "px-6 py-3 text-[0.9rem]",
  lg: "px-8 py-[0.9rem] text-[1rem]",
